function [MAE,NMAE,auc,percentage_sMCI,percentage_AD,percentage_pMCI,corr_MCI_age,corr_MCI_reserve]=...
    build_rpdpm_MCItoAD(y,ages,labels,diagnose,classes,ranges,...
...
% ------------------------------------------------------------
% Filename:    build_rpdpm_MCItoAD.m
% Description: Building the RPDPM model 
...
[ages_onset,gt_onset,m_test]=get_Onset_MCI_MCItoAD(DPS_test,...
...
[ages_onset,gt_onset,m_train]=get_Onset_MCI_MCItoAD(DPS_train_2,...
...
percentage_AD=[m_test.percentage_AD,m_train.percentage_AD];
percentage_pMCI=[m_test.percentage_pMCI,m_train.percentage_pMCI];
